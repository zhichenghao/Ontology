...
Ontology is useful because it can be used to communicated between **people**. Technical terms are often used with different meaning by different groups in an organization, e.g."Supplier". Ontology can be used to communicated between **computers**. e.g. &lt;cost&gt;£10&lt;/cost&gt; v.s. &lt;price&gt;£10&lt;price&gt;. Ontology can be used to communicated between **people and computers**, e.g. how to read friend (Ann, Bob).
